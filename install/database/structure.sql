...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$config` (
  ...
  `_conf_subgroup` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$language` (
  `id` int(11) NOT NULL auto_increment,
  `iso_name` varchar(2) NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$message` (
  ...
  `author_id` int(11) NOT NULL default '0',
  `author_nickname` varchar(255) NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$message_log` (
  ...
  `target_user_nickname` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$room` (
  ...
  `default_message_color` varchar(6) NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$session` (
  `_s_id` varchar(32) NOT NULL default '',
  `_s_ip` varchar(15) NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$user` (
  ...
  `password` varchar(32) NOT NULL default '',
  `password_new` varchar(32) NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `$$$DB_PREFIX$$$version` (
  ...
  `version_check_key` varchar(32) NOT NULL default '',
