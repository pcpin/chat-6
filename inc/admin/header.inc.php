...
$tpl->addVars('main', ARRAY('username'=>htmlspecialchars($current_user->login),
                            'chat_name'=>htmlspecialchars($session->_conf_all['chat_name']),
                            'welcome_msg'=>htmlspecialchars(str_replace('[USER]', $current_user->login, $l->g('welcome_user')))
                            ));
