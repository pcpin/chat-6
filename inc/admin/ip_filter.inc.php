...
// JS files
$_js_files[]='./js/admin/ip_filter.js';
...
$_js_lng[]='allow';
$_js_lng[]='deny';
$_js_lng[]='ip_mask_invalid';
$_js_lng[]='expiration_date_invalid';
$_js_lng[]='confirm_delete_addresses';

$_body_onload[]='initIPFilterForm()';

// Initialize template handler
_pcpin_loadClass('pcpintpl'); $tpl=new PcpinTpl();
$tpl->setBasedir('./tpl');
$tpl->readTemplatesFromFile('./admin/ip_filter.tpl');
