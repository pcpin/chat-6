...
function _pcpin_get_upgrade_queries() {
  ...
  switch (PCPIN_UPGRADE_INSTALLED_VERSION) {
    ...
    case 6.11:
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x536f756e6473 WHERE `le`.`code` = 'sounds' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x416c6c6f7720736f756e6420656666656374733f WHERE `le`.`code` = '_conf_allow_sounds' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x53696368746261726b656974 WHERE `le`.`code` = 'visibility' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x547970 WHERE `le`.`code` = 'type' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x42656e75747a6572646566696e69657274652050726f66696c66656c646572 WHERE `le`.`code` = 'custom_profile_fields' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x44656661756c7477657274 WHERE `le`.`code` = 'default_value' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x426573636872656962626172 WHERE `le`.`code` = 'writeable' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x446174656e62616e6b206f7074696d696572656e WHERE `le`.`code` = 'optimize_database' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x4e6575656e2042656e75747a65722068696e7a7566c3bc67656e WHERE `le`.`code` = 'add_new_user' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x42656e75747a6572207775726465206572666f6c6772656963682068696e7a75676566c3bc6774 WHERE `le`.`code` = 'new_user_added' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x42656e75747a65722d52656769737472696572756e6720616b746976696572656e3f WHERE `le`.`code` = '_conf_allow_user_registration' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x416b746976696572756e6773656d61696c WHERE `le`.`code` = 'activation_email' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x416b746976696572756e672064757263682041646d696e6973747261746f72 WHERE `le`.`code` = 'activation_by_admin' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` =  WHERE `le`.`code` = 'email_new_user_activation_notification' AND `la`.`iso_name` = 'de'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x49676e6f7269657274652042656e75747a6572 WHERE `le`.`code` = 'ignore_list' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x4175737761686c WHERE `le`.`code` = 'choices' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x4e657565732046656c642068696e7a7566c3bc67656e WHERE `le`.`code` = 'create_new_field' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x45696e6661636865204175737761686c WHERE `le`.`code` = 'simple_choice' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x4d6568727a65696c69676573205465787466656c64 WHERE `le`.`code` = 'textarea' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x45696e7a65696c69676573205465787466656c64 WHERE `le`.`code` = 'single_text_field' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x4d6568726661636865204175737761686c WHERE `le`.`code` = 'multiple_choice' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x50726f66696c62657369747a6572 WHERE `le`.`code` = 'profile_owner' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x576f6c6c656e20536965207769726b6c696368206469657365732046656c64206cc3b6736368656e3f WHERE `le`.`code` = 'sure_delete_field' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x4461732046656c64207775726465206572666f6c6772656963682067656cc3b673636874 WHERE `le`.`code` = 'field_deleted' AND `la`.`iso_name` = 'de'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x476562656e20536965206269747465206d696e6465737465732065696e65204175737761686c6f7074696f6e2065696e WHERE `le`.`code` = 'no_options_specified' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x4e657565732046656c64207775726465206572666f6c6772656963682068696e7a75676566c3bc6774 WHERE `le`.`code` = 'field_created' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x46656c642065646974696572656e WHERE `le`.`code` = 'edit_field' AND `la`.`iso_name` = 'de'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0x466c6f6f64696e67 WHERE `le`.`code` = 'flooding' AND `la`.`iso_name` = 'de'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd094d0bed0bfd0bed0bbd0bdd0b8d182d0b5d0bbd18cd0bdd18bd0b520d0bfd0bed0bbd18f20d0b220d0bfd180d0bed184d0b8d0bbd0b5 WHERE `le`.`code` = 'custom_profile_fields' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd092d0bed0b7d0bcd0bed0b6d0bdd0bed181d182d18c20d0b8d0b7d0bcd0b5d0bdd0b5d0bdd0b8d18f WHERE `le`.`code` = 'writeable' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd097d0bdd0b0d187d0b5d0bdd0b8d0b520d0bfd0be20d183d0bcd0bed0bbd187d0b0d0bdd0b8d18e WHERE `le`.`code` = 'default_value' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd092d0b8d0b4d0b8d0bcd0bed181d182d18c WHERE `le`.`code` = 'visibility' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd090d0bad182d0b8d0b2d0b8d180d0bed0b2d0b0d182d18c20d0b7d0b2d183d0bad0bed0b2d18bd0b520d18dd184d184d0b5d0bad182d18b3f WHERE `le`.`code` = '_conf_allow_sounds' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd097d0b2d183d0bad0bed0b2d18bd0b520d18dd184d184d0b5d0bad182d18b WHERE `le`.`code` = 'sounds' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd0a2d0b8d0bf WHERE `le`.`code` = 'type' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd09ed0bfd182d0b8d0bcd0b8d180d0bed0b2d0b0d182d18c20d0b1d0b0d0b7d18320d0b4d0b0d0bdd0bdd18bd185 WHERE `le`.`code` = 'optimize_database' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd094d0bed0b1d0b0d0b2d0b8d182d18c20d0bdd0bed0b2d0bed0b3d0be20d0bfd0bed0bbd18cd0b7d0bed0b2d0b0d182d0b5d0bbd18f WHERE `le`.`code` = 'add_new_user' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd09dd0bed0b2d18bd0b920d0b0d0bad0bad0b0d183d0bdd18220d0b4d0bed0b1d0b0d0b2d0bbd0b5d0bd WHERE `le`.`code` = 'new_user_added' AND `la`.`iso_name` = 'ru'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd090d0bad182d0b8d0b2d0b0d186d0b8d18f20d0bfd0be20452d4d61696c WHERE `le`.`code` = 'activation_email' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd090d0bad182d0b8d0b2d0b0d186d0b8d18f20d090d0b4d0bcd0b8d0bdd0b8d181d182d180d0b0d182d0bed180d0bed0bc2e WHERE `le`.`code` = 'activation_by_admin' AND `la`.`iso_name` = 'ru'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd098d0b3d0bdd0bed180d0b8d180d183d0b5d0bcd18bd0b520d0bfd0bed0bbd18cd0b7d0bed0b2d0b0d182d0b5d0bbd0b8 WHERE `le`.`code` = 'ignore_list' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd092d0b0d180d0b8d0b0d0bdd182d18b20d0b2d18bd0b1d0bed180d0b0 WHERE `le`.`code` = 'choices' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd094d0bed0b1d0b0d0b2d0b8d182d18c20d0bdd0bed0b2d0bed0b520d0bfd0bed0bbd0b5 WHERE `le`.`code` = 'create_new_field' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd09fd180d0bed181d182d0bed0b920d0b2d18bd0b1d0bed180 WHERE `le`.`code` = 'simple_choice' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd0a2d0b5d0bad181d182 WHERE `le`.`code` = 'textarea' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd0a2d0b5d0bad181d1822028d0bed0b4d0bdd0b020d181d182d180d0bed0bad0b029 WHERE `le`.`code` = 'single_text_field' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd09cd0bdd0bed0b3d0bed0bad180d0b0d182d0bdd18bd0b920d0b2d18bd0b1d0bed180 WHERE `le`.`code` = 'multiple_choice' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd092d0bbd0b0d0b4d0b5d0bbd0b5d18620d0bfd180d0bed184d0b8d0bbd18f WHERE `le`.`code` = 'profile_owner' AND `la`.`iso_name` = 'ru'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd09fd0bed0bbd0b520d183d0b4d0b0d0bbd0b5d0bdd0be WHERE `le`.`code` = 'field_deleted' AND `la`.`iso_name` = 'ru'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd09fd0bed0bbd0b520d0b4d0bed0b1d0b0d0b2d0bbd0b5d0bdd0be WHERE `le`.`code` = 'field_created' AND `la`.`iso_name` = 'ru'";
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd098d0b7d0bcd0b5d0bdd0b8d182d18c20d0bfd0bed0bbd0b5 WHERE `le`.`code` = 'edit_field' AND `la`.`iso_name` = 'ru'";
      ...
      $queries[]="`".PCPIN_DB_PREFIX."language` AS `la` LEFT JOIN `".PCPIN_DB_PREFIX."language_expression` AS `le` ON `le`.`language_id` = `la`.`id` SET `le`.`value` = 0xd0a4d0bbd183d0b4 WHERE `le`.`code` = 'flooding' AND `la`.`iso_name` = 'ru'";
