    ...
    if ($__pcpin_upgrade['db_version']<$__pcpin_upgrade['file_version']) {
      ...
      switch ($__pcpin_upgrade['db_version']) {
        ...
        case 6.11:
          ...
          $__pcpin_upgrade['session']->_db_query("INSERT INTO `".PCPIN_DB_PREFIX."language_expression` ( `language_id`, `code`, `value`, `multi_row` ) SELECT DISTINCT `".PCPIN_DB_PREFIX."language_expression`.`language_id` AS `language_id`, 'flood_protection_max_messages' AS `code`,  AS `value`, 'n' AS `multi_row` FROM `".PCPIN_DB_PREFIX."language_expression`");
          $__pcpin_upgrade['session']->_db_query("INSERT INTO `".PCPIN_DB_PREFIX."language_expression` ( `language_id`, `code`, `value`, `multi_row` ) SELECT DISTINCT `".PCPIN_DB_PREFIX."language_expression`.`language_id` AS `language_id`, 'flood_protection_mute_time' AS `code`, 0x466f7220686f77206d616e79207365636f6e6473206d75746520757365727320666f7220666c6f6f64696e673f AS `value`, 'n' AS `multi_row` FROM `".PCPIN_DB_PREFIX."language_expression`");
          $__pcpin_upgrade['session']->_db_query("INSERT INTO `".PCPIN_DB_PREFIX."language_expression` ( `language_id`, `code`, `value`, `multi_row` ) SELECT DISTINCT `".PCPIN_DB_PREFIX."language_expression`.`language_id` AS `language_id`, 'flood_protection_message_delay' AS `code`, 0x4d696e696d756d2074696d6520706572696f6420696e207365636f6e6473206265747765656e2074776f206d657373616765732066726f6d207468652073616d6520757365722e AS `value`, 'n' AS `multi_row` FROM `".PCPIN_DB_PREFIX."language_expression`");
          $__pcpin_upgrade['session']->_db_query("INSERT INTO `".PCPIN_DB_PREFIX."language_expression` ( `language_id`, `code`, `value`, `multi_row` ) SELECT DISTINCT `".PCPIN_DB_PREFIX."language_expression`.`language_id` AS `language_id`, 'flooding' AS `code`, 0x466c6f6f64696e67 AS `value`, 'n' AS `multi_row` FROM `".PCPIN_DB_PREFIX."language_expression`");
          $__pcpin_upgrade['session']->_db_query("INSERT INTO `".PCPIN_DB_PREFIX."config` ( `_conf_id` , `_conf_group` , `_conf_subgroup` , `_conf_name` , `_conf_value` , `_conf_type` , `_conf_choices` , `_conf_description` )  VALUES ( '', 'chat', '{LNG_MESSAGES}', 'flood_protection_max_messages', '5', 'int_range', '3|*', '{LNG_FLOOD_PROTECTION_MAX_MESSAGES}' )");
          $__pcpin_upgrade['session']->_db_query("INSERT INTO `".PCPIN_DB_PREFIX."config` ( `_conf_id` , `_conf_group` , `_conf_subgroup` , `_conf_name` , `_conf_value` , `_conf_type` , `_conf_choices` , `_conf_description` )  VALUES ( '', 'chat', '{LNG_MESSAGES}', 'flood_protection_mute_time', '60', 'int_range', '1|*', '{LNG_FLOOD_PROTECTION_MUTE_TIME}' )");
          $__pcpin_upgrade['session']->_db_query("INSERT INTO `".PCPIN_DB_PREFIX."config` ( `_conf_id` , `_conf_group` , `_conf_subgroup` , `_conf_name` , `_conf_value` , `_conf_type` , `_conf_choices` , `_conf_description` )  VALUES ( '', 'chat', '{LNG_MESSAGES}', 'flood_protection_message_delay', '1', 'int_range', '0|*', '{LNG_FLOOD_PROTECTION_MESSAGE_DELAY}' )");
          $__pcpin_upgrade['session']->_db_query("ALTER TABLE `".PCPIN_DB_PREFIX."session` ADD `_s_last_sent_message_time` DATETIME DEFAULT '0000-00-00 00:00:00' NOT NULL AFTER `_s_last_message_id`, ADD `_s_last_sent_message_hash` CHAR(32) default '' NOT NULL AFTER `_s_last_sent_message_time`, ADD `_s_last_sent_message_repeats_count` int(10) unsigned NOT NULL default '0' AFTER `_s_last_sent_message_hash`");
