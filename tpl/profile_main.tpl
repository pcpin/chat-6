<PCPIN:TPL name="main">
<table id="profile_header_tbl" class="tbl" border="0" cellspacing="0" cellpadding="0" width="100%" style="display:none;">
  <tr>
...
<table id="other_profile_header_tbl" class="tbl" border="0" cellspacing="0" cellpadding="0" width="99%" style="display:none;margin:5px;">
  <tr>
    <td class="tbl_header_main" id="other_profile_header_tbl_title">
    </td>
  </tr>
